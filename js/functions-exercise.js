...
//    return "Wudup " + name + "!";
// }
// let helloMessage = sayHello("Donald");
...
//     return "Wudup " + name + "!";
// }
// // let myName = sayHello("Donald");
// // console.log(myName);
//
// const myName = "Donald"
// const resp = sayHello(myName);
// console.log(resp);
//
...
// }
//
// console.log(calculateTip(0.20, 20)); // output: 4
// console.log(calculateTip(0.25, 25.50)); // output: 6.375
// console.log(calculateTip(0.15, 33.42)); // output: 5.013
...
//
// discountedPrice = applyDiscount(45.99, 0.12);
// console.log(discountedPrice); // Output: 40.4712